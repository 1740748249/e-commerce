package com.ecommerce.common.autoconfigure.swagger;

import cn.hutool.core.convert.ConverterRegistry;
import com.fasterxml.classmate.TypeResolver;
import com.ecommerce.common.domain.R;
import com.ecommerce.common.utils.TjTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "ecommerce.swagger", name = "enable",havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "ecommerce.swagger", name = "enableResponseWrap",havingValue = "true")
