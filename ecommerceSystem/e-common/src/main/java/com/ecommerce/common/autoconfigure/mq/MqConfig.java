package com.ecommerce.common.autoconfigure.mq;
...
import static com.ecommerce.common.constants.MqConstants.Key.ERROR_KEY_PREFIX;
import static com.ecommerce.common.constants.MqConstants.Queue.ERROR_QUEUE_TEMPLATE;
...
public class MqConfig implements EnvironmentAware{
    ...
    public MessageRecoverer republishMessageRecoverer(RabbitTemplate rabbitTemplate){
        ...
        RepublishMessageRecoverer inner = new RepublishMessageRecoverer(
                rabbitTemplate, ERROR_EXCHANGE, defaultErrorRoutingKey);
        return (message, cause) -> {
            log.error("MQ 消息处理失败，即将投递到死信队列", cause);
            inner.recover(message, cause);
        };
    }
